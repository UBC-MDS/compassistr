...
`shiny_hunt()` was developed for the specific application of catching shiny Pokemon [https://pokemon.fandom.com/wiki/Shiny_Pokémon](https://pokemon.fandom.com/wiki/Shiny_Pokémon). Because the encounter rate depends on the 'gen' (release series) of the desired Pokemon, the only required input is `gen`
